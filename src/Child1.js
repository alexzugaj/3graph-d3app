...
class Child1 extends Component {
  ...
  render(){
    return <div>
      ...
      <div>
        <input type="radio" name="tips" value="sex"/> Sex
        <input type="radio" name="tips" value="smoker"/> Smoker
        <input type="radio" name="tips" value="day"/> Day
        <input type="radio" name="tips" value="time"/> Time
      </div>
    </div>
  }
}
